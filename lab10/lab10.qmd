...
cv_states$abb <- factor(cv_states$abbs)
...
filter_dates <- seq(as.Date("2021-06-15"), as.Date("2021-11-01"), by="14 days")
...
# Create hover text to include state name, new cases per 100k, cases, and deaths
cv_per100$hover <- with(cv_per100, paste(state_name, '<br>', "Cases per 100k: ", newper100k,
      '<br>', "Cases: ", cases, '<br>', "Deaths: ", deaths))
